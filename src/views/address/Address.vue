    ...
    <div class="address">
        <div class="page-address-list" data-log="地址列表">
            <div class="address-choose">
                <ul class="ui-list">
                    <li class="ui-list-item" v-for="(address,index) in addresses" @click="defaultAddress(address.id)">
                        <p class="ui_fz30">
    ...
    export default {
        ...
        methods: {
            ...
            defaultAddress(address_id) {
                ...
                this.axios.patch('api/address', {address_id: address_id}).then(response => {
